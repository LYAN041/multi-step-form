const Step5 = () => {
    return (
        <div className="container d-flex" id="content-step5">
            <div className="row">
                <div className="column">
                    <div className="d-flex flex-column align-items-center" id="container-step5">
                        ...
                        <h1 className="mt-3 mb-3">Obrigado!</h1>
                        <p className="text-center">Obrigado por confirmar sua inscrição! Esperamos que você se divirta
                            usando nossa plataforma. Se você precisar de suporte, por favor, sinta-se livre
                            para nos enviar um e-mail support@gmail.com.</p>
                    </div>
                </div>
            </div>
        </div>
